...
Если нужно, чтобы ИИ-бот отрабатывался только в определенном мессенджере, то выберите в конструкторе условий необходимый мессенджер во вкладке "Выбор бота", как описано выше в параграфе "[Конструктор условий](settings.md#konstruktor-uslovii)".
{% endhint %}
...
Чтобы передавать данные в бот необходимо в [**настройках бота**](settings.md#nastroiki-bota) прописать одну из следующих команд:
...
Если модель вводит в заблуждение клиентов и говорит о несуществующих услугах и товарах, то можно поставить галочку “Минимизацией фантазий" в списке "[Заготовленные настройки](settings.md#zagotovlennye-nastroiki)", а также попробовать уменьшить креативность модели.&#x20;
