...
Команда "вызываю блок <mark style="color:red;">31241050</mark>" является отладочной и понадобится для понимания того, какие данные записывает бот (см. параграф "[Тестирование](sheets.md#testirovanie-bota)").
...
Подробнее о настройках каждой платежной системы рассказали в разделе "[Эквайринг](../../integration/payments/)".
{% endhint %}
...
После тестирования и отладки работы бота, прописывайте команду в [настройках бота](sheets.md#nastroiki-ai-assistenta) "start\_block\_from\_ai <mark style="color:red;">31241050</mark>".
